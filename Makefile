...
UINTENT_VARS = UINTENT_DLDIR UINTENT_OPENWRT_DIR UINTENT_SCRIPTDIR UINTENT_CONFIG_DIR UINTENT_PRITARGET UINTENT_SUBTARGET OPENWRT_VERSION OPENWRT_DOWNLOAD_URL UINTENT_DEVICE_IP
